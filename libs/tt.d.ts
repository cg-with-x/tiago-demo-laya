...
declare namespace tt {
    ...
    */
     ...
     * 取消监听小游戏回到前台的事件
     */
    function offShow(callback: (res?: any) => void): void;
    ...
    */
    ...
    function getLeftMenuButtonBoundingClientRect(): {
        width: number,
        height: number,
        top: number,
        right: number,
    ...
    function getLeftMenuButtonLayout(): {
        width: number,
        height: number,
        top: number,
        right: number,
    ...
    /** 是否显示SDK的胶囊按钮 */
    function setMenuButtonVisibility(value: {visible: boolean}): void

    /** 显示SDK的 更多 菜单 */
    function showMorePanel(): void
     ...
     * 主动拉起转发，进入选择通讯录界面。
     */
    function shareAppMessage(object: { title?: string, imageUrl?: string, query?: string, desc?: string, channel?: string, extra?: object, success?: (res?: any) => void, fail?: (res?: any) => void, complete?: (res?: any) => void }): void;

    function navigateToVideoView(object: { videoId: string, success?: (res?: any) => void, fail?: (res?: any) => void, complete?: (res?: any) => void }): void;

    function reportAnalytics(eventName: string, params: { [key: string]: any} )
    ...
    */
     ...
     */
    function login(object: { timeout?: number, force?: boolean, success?: (res: { code: string }) => void, fail?: (res?: any) => void, complete?: (res?: any) => void }): void;
    ...
    */
     ...
     * @param options
     */
    function openSchema(options: { schema: string }): void;

    /**
     * 异步调用宿主扩展 API
     */
    function callHostMethod(options: {
        method: string,
     ...
     * 同步调用宿主扩展 API
     */
    function callHostMethodSync(options: {
        method: string,
        extra: { [key: string]: any },
    }): void

    function getUseDuration(options: {
        success?: (res?: any) => void,
        fail?: (res?: any) => void,
        complete?: (res?: any) => void
    }): void
